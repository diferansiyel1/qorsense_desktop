...
from PyQt6.QtWidgets import QDockWidget, QFrame, QHBoxLayout, QLabel, QScrollArea, QVBoxLayout, QWidget
...
class SensorStatusPanel(QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._selected_sensor: str | None = None
    ...
    def get_selected_sensor(self) -> str | None:
